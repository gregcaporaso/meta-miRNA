...
# The human miRBase database needs to be downloaded by the user.
    ...
    def run(self, **kwargs):
        ...
        for input_filepath in input_filepaths:
            ...
            command = "%s -i %s -r %s -o %s --enable_rev_strand_match --max_accepts 1 --max_rejects 8 --stepwords 8 --word_length 8 -O 20" % (self.parallel_pick_otus_uclust_ref_path, input_filepath, all_ncrna_except_miRNA_database_dir, temp_dir)
            if self.verbose:
                print command
